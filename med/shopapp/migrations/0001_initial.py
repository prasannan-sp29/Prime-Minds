    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shopapp.customer')),
                ('medicine', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='shopapp.medicine')),
            ],
        ),
        migrations.CreateModel(
            name='Delivery',
            fields=[
                ...
                ('sale', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='shopapp.sale')),
            ],
        ),
        migrations.CreateModel(
            name='SalesOrder',
