...
class PurchaseItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.total = self.price * self.quantity  # Calculate the total before saving
...
class Sale(models.Model):
    ...
    tax = models.IntegerField(choices=TAX_CHOICES,default=0)
    total = models.DecimalField(max_digits=10, decimal_places=2, editable=False, default=0)
    confirmed = models.CharField(max_length=20, choices=SALE_STATUS_CHOICES, default='SALE CONTER')
