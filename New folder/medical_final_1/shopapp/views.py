...
def add_purchase(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            tablet_name = form.cleaned_data['tablet_name']
            print(tablet_name)
            if tablet_name.newTag:  # If it’s a new tag, create a new tablet
                tablet, created = Tablet.objects.get_or_create(name=tablet_name)
                form.instance.tablet_name = tablet
