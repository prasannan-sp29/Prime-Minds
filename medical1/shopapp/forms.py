...
class PurchaseItemForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'tablet_name': forms.Select(attrs={'class': 'select2', 'id': 'id_tablet_name'}),
        }

    # def clean_tablet_name(self):
    #     tablet_name = self.cleaned_data.get('tablet_name')
    #     print(tablet_name)
    #     print("@@@@")
    #     try:
    #         tablet, created = Medicine.objects.get_or_create(medicine_name=tablet_name)
    #         return tablet
    #     except:
    #         print("$$$$$$$$$$$$$$$$$$$$$$")
