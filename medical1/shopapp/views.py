...
def add_purchase(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            tablet = form.cleaned_data['tablet_name']
            new_tablet_name = request.POST.get('new_tablet_name')
            price = form.cleaned_data['price']
            quantity = form.cleaned_data['quantity']
            print(tablet,new_tablet_name,price,quantity)

            if new_tablet_name:
                tablet, created = Tablet.objects.get_or_create(tablet_name=new_tablet_name)
                purchase_item.tablet_name = tablet
            else:
                purchase_item.tablet_name = tablet
